...
$hero_subtitle = 'Modulares Workforce Management';

// Problem Section
$problems = array(
	'Excel-Listen und manuellen Korrekturen',
	'Unklaren Überstunden- und Ferienständen',
	'Fehlender Transparenz für Mitarbeitende & HR',
	'Gesetzlichen Anforderungen (ArG, AZG)',
	'Starreren Systemen, die nicht zur Organisation passen',
);
$problem_result = 'Ergebnis: hoher Aufwand und Unsicherheit.';

// Solution Section
$solution_title       = 'Unsere Lösung';
$solution_subtitle    = 'Modulares Workforce Management';
$solution_description = 'DataEnergie bietet eine digitale Zeiterfassung, die sich an Ihre Organisation anpasst – nicht umgekehrt.';
$solution_tagline     = 'Einfach für Mitarbeitende. Übersichtlich für HR.';

// Kernfunktionen (Funktionen)
$kernfunktionen = array(
	'Arbeitszeit- & Pausenerfassung',
	'Überstunden & Soll-/Ist-Vergleich',
	'Ferien & Absenzen',
	'Tages-, Wochen- & Monatsübersichten',
	'Rollen & Freigaben (Mitarbeiter, HR, Vorgesetzte)',
	'Mandanten- & Standortfähig',
);

// Mehrwert (Ihr Mehrwert)
$mehrwert = array(
	'Klare und nachvollziehbare Zeiterfassung',
	'Entlastung von HR & Administration',
	'Transparenz für Mitarbeitende',
	'Flexible Anpassung an Arbeitsmodelle',
	'Datenschutz- & CH-konforme Umsetzung',
);
$mehrwert_tagline = 'Kontrolle ohne Bürokratie.';

// Zielgruppe
$zielgruppen = array(
	'KMU & Organisationen',
	'Unternehmen mit Schicht- oder Gleitzeit',
	'HR- & Geschäftsleitungen',
	'Betriebe mit Homeoffice / Hybrid',
	'Organisationen mit mehreren Standorten',
);

// Betriebsmodell
$betriebsmodell = array(
	'SaaS (Cloud-basiert)',
	'Modular erweiterbar',
	'Lizenzbasiertes Preismodell',
	'Optional: Integration in bestehende Systeme',
);

// CTA Section
$cta_title       = 'Möchten Sie Ihre Zeiterfassung vereinfachen?';
$cta_description = 'Lernen Sie unsere Lösung kennen. Wir zeigen Ihnen, wie moderne Zeiterfassung heute funktioniert.';
$cta_button_text = 'Produkt kennenlernen';
?>
...
<section class="page-content" aria-labelledby="wfm-main-heading">
	<div class="container">
		...
		<div class="m365-problem-section">
			<div class="problem-box">
				...
				<div class="problem-box__content">
					...
					<p class="problem-box__intro">Viele Unternehmen kämpfen mit:</p>
		...
		<div class="m365-solution-section">
			<div class="solution-header text-center">
				...
				<h2 id="wfm-main-heading" class="section-title"><?php echo esc_html( $solution_subtitle ); ?></h2>
		...
		<div class="m365-two-columns">
			...
			<div class="m365-column">
				<div class="column-header">
					...
					<span class="column-subtitle">Kernfunktionen</span>
				</div>
				<ul class="check-list">
					<?php foreach ( $kernfunktionen as $item ) : ?>
			...
			<div class="m365-column">
				<div class="column-header">
					...
					<h3 class="column-title">Vorteile für Ihr Unternehmen</h3>
		...
		<div class="m365-vorteile-section">
			<h2 class="section-title text-center">Betriebsmodell</h2>
			<div class="vorteile-grid">
				<?php foreach ( $betriebsmodell as $item ) : ?>
					<div class="vorteil-item">
						<span class="vorteil-item__icon" aria-hidden="true"><?php echo $icon_svgs['cloud']; ?></span>
						<span class="vorteil-item__text"><?php echo esc_html( $item ); ?></span>
					</div>
				<?php endforeach; ?>
			</div>
		</div>
